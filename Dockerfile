...
RUN apt-get update && \
    ...
    ca-certificates curl python3 ripgrep ffmpeg gcc python3-dev libffi-dev procps git openssh-client docker-cli xz-utils rclone && \
...
# VOLUME [ "/opt/data" ]  # patched out for Railway: VOLUME directive unsupported; using Railway Volume mounted at /opt/data instead
